...
namespace SellPhone
{
    public partial class FindImportControl : UserControl
    {
        ...
        private void findBtn_Click(object sender, EventArgs e)
        {
            ...
            if(checkBoxDay.Checked)
            {
                comm = new SqlCommand("LocPhieuNhap_TheoNgay", conn);
            ...
            {
                comm = new SqlCommand("LocPhieuNhap_TheoThang", conn);
                comm.CommandType = CommandType.StoredProcedure;
            ...
            {
                comm = new SqlCommand("LocPhieuNhap_TheoQuy", conn);
                comm.CommandType = CommandType.StoredProcedure;
                int quy = 1;
            ...
            {
                comm = new SqlCommand("LocPhieuNhap_TheoNam", conn);
                comm.CommandType = CommandType.StoredProcedure;
                comm.Parameters.Add(new SqlParameter("@Nam", SqlDbType.Int));
                comm.Parameters["@Nam"].Value = yearInp.Text;
            }
